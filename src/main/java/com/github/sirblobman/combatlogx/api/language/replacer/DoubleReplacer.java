...
public final class DoubleReplacer extends Replacer {
    ...
    public DoubleReplacer(@NotNull String target, double replacement, @Nullable DecimalFormat format) {
        this(target, replacement, format, (DecimalFormatSymbols)null);
    }

    public DoubleReplacer(@NotNull String target, double replacement, @Nullable DecimalFormat format, @Nullable DecimalFormatSymbols symbols) {
        super(target);
