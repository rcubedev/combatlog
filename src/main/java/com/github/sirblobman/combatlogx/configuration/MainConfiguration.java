...
public class Configuration extends WrappedConfig {
    ...
    @Comment({"Which projectiles will be ignored when the 'link_projectiles' option is enabled?",
            "If 'link_projectiles' is false, all projectiles will be ignored.",
            ...
            "ignored_projectiles = [\"minecraft:egg\", \"minecraft:ender_pearl\", \"minecraft:snowball\"]"
    })
