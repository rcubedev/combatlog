...
//println("=== Applying multiloader-api plugin for ${loader}'s ${project.name}, isCommon=${isCommonLoader} ===")
...
java {
    toolchain.languageVersion = JavaLanguageVersion.of(commonEnv.prop("java.version"))
    // withSourcesJar()
    // withJavadocJar()
}
...
tasks {
    ...
    withType<ProcessResources>().configureEach {
        val expandProps = mapOf(
            "javaVersion" to commonEnv.propOrNull("java.version"),
            "minecraftVersion" to commonEnv.propOrNull("minecraft_version"),
            "minMinecraftVersion" to commonEnv.propOrNull("min_minecraft_version"),
            "fabricLoaderVersion" to commonEnv.depOrNull("fabric_loader"),
            "fabricApiVersion" to commonEnv.depOrNull("fabric_api"),
            "neoForgeVersion" to commonEnv.depOrNull("neoforge"),
            "forgeVersion" to commonEnv.depOrNull("forge")
