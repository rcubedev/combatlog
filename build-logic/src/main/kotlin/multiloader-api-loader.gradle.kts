...
//println("=== Applying multiloader-api-loader plugin for ${loader}'s ${project.name} ===")
...
//        println("[multiloader-api-loader] Processing loader sourceset '$loaderSSName'")
//        println("[multiloader-api-loader]  Raw depKeys: $depKeys")

        // Deduplicate depKeys to avoid adding resources multiple times
        val uniqueDepKeys = depKeys.distinct()
//        println("[multiloader-api-loader]  Unique depKeys: $uniqueDepKeys")
