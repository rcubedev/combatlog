...
import net.kyori.adventure.text.minimessage.MiniMessage;import org.jetbrains.annotations.NotNull;

@DisplayNameConvention(NamingSchemes.SPACE_SEPARATED_LOWER_CASE_INITIAL_UPPER_CASE)
@SerializedNameConvention(NamingSchemes.SNAKE_CASE)
public class ActionBarConfiguration extends WrappedConfig {
    ...
    @Comment("Scale is the amount of symbols for the {bars} placeholder.")
    public long scale = 15;
